...
You can use this https://start.spring.io/#!type=maven-project&groupId=com.example&artifactId=rest-service-cors&name=rest-service-cors&description=Demo%20project%20for%20Spring%20Boot&packageName=com.example.restservicecors&dependencies=web[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
simple data representation (POJO in Java or data class in Kotlin) with fields, constructors, and accessors for the `id` and `content`
data, as the following listing show:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/restservicecors/Greeting.kt[]
----
====
...
annotation, and the `GreetingController` shown in the following listing handles `GET`
...
.Java
----
include::complete/src/main/java/com/example/restservicecors/GreetingController.java[lines=1..22;29]
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/restservicecors/GreetingController.kt[lines=1..19;26]
----
====
...
Therefore, returned object data is inserted directly into the response body.
...
.Java
----
include::complete/src/main/java/com/example/restservicecors/GreetingController.java[lines=16..22]
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/restservicecors/GreetingController.kt[lines=14..19]
----
====
...
The following listing show the
...
.Java
----
include::complete/src/main/java/com/example/restservicecors/GreetingController.java[lines=24..28]
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/restservicecors/GreetingController.kt[lines=21..25]
----
====
...
.Java
----
include::complete/src/main/java/com/example/restservicecors/RestServiceCorsApplication.java[lines=17..24]
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/restservicecors/RestServiceCorsApplication.kt[lines=13..17]
----
====
...
listing shows that initial class:
...
.Kotlin
----
include::initial-kotlin/src/main/kotlin/com/example/restservicecors/RestServiceCorsApplication.kt[]
----
====
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/restservicecors/RestServiceCorsApplication.kt[lines=12..17]
----
====
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/restservicecors/RestServiceCorsApplication.kt[]
----
====
...
First, create a simple JavaScript file named `hello.js` (from `public/hello.js`)
...
It is loaded by `index.html`, as the following listing (from `public/index.html`)
shows:
...
To test the CORS behavior, you need to start the client from another server or port.
