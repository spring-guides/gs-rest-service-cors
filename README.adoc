...
simple data representation (record in Java or data class in Kotlin) with fields, constructors, and accessors for the `id` and `content`
...
NOTE: Spring uses the {jackson}[Jackson JSON] library to automatically serialize instances
...
.Java
----
include::complete/src/main/java/com/example/restservicecors/GreetingController.java[lines=1..16;18..23;29]
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/restservicecors/GreetingController.kt[lines=1..13;15..20;26]
----
====
...
.Java
----
include::complete/src/main/java/com/example/restservicecors/GreetingController.java[lines=17..22]
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
...
specific method. By default, it allows all origins, all headers, and the HTTP methods
